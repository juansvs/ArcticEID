...
While it may be unrealistic to expect the system to reach equilibrium any time soon, we can use the model to infer the expected density of individuals who are temporarily immune, *i.e.* who had the disease and recovered. This would be represented by seropositive alive individuals. Based on the equilibria formula, the density is given by
